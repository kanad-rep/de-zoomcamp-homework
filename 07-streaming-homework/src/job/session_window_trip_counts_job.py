...
def create_green_trips_source(t_env):
    table_name = "session_counts_source"
    source_ddl = f"""
...
def create_session_trip_counts_sink(t_env):
    table_name = "session_trip_counts"
    sink_ddl = f"""
        CREATE TABLE {table_name} (
...
def run():
    ...
    sink_table = create_session_trip_counts_sink(t_env)
